...
<body>
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="bi-circle-fill" viewBox="0 0 16 16">
        ...
        <symbol id="bi-menu-app" viewBox="0 0 16 16">
        ...
        <symbol id="bi-trash3" viewBox="0 0 16 16">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/') }}">{{ __('Menu 3') }}</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/') }}">{{ __('Menu 4') }}</a>
                        </li>
